...
function organizeInventory(inventory) {
	...
	for (const item of inventory) {
		...
		if (typeof inventarioObj[item.category] === "undefined") {
			inventarioObj[item.category] = {};
		}

		if (typeof inventarioObj[item.category][item.name] === "undefined") {
			inventarioObj[item.category][item.name] = item.quantity;
		} else {
			inventarioObj[item.category][item.name] += item.quantity;
		}
